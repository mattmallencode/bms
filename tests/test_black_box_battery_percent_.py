...
class TestDisplayPercentage(TestCase):

    def test_view_battery_percentage(self):
        '''
        Test to see if the battery percent is visible to user.
        ...
        #Next the settings button is pressed. If this is true then the battery percent is visible.
