...
def time_till_full(charger, battery_percentage) -> float:
    """
...
def time_till_empty(charger, phone, battery_percentage) -> float:
    """
...
def state_of_charge(charger, phone, battery_percentage) -> float:
    """
    ...
    soc = battery_percentage + ((i/charger.report_functional_capacity()) * time_step)
